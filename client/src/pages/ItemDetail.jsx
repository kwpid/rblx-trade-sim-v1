...
const ItemDetail = () => {
  ...
  // ... (skipping unchanged lines is risky with replace_file_content if I don't use multi)
  // I will use multi_replace for safety or just target the specific blocks.
  // I'll stick to replace_file_content but do two separate calls or one large block?
  // One large block for the function change + JSX change is too big (lines 35 to 666).
